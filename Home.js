...
_renderItemHospitalImageList=({item, index})=>{
 ...
 capitalizeFirstLetter=(string)=> {
  ...
  _renderSpeciality=({item, index})=>{
    ...
    return(
      <TouchableOpacity style={{width:wp('27%'), margin:10,marginRight:5,marginTop:10,marginBottom:10, height:hp('16%')}}
      onPress={() => this.selectedFirst(item, index)}
      activeOpacity={0.99}>
          <View   style  = {{width:'100%', height:'100%',backgroundColor:'white',shadowColor: "#000",
              shadowOffset: {
...
//      NetInfo.isConnected.addEventListener('connectionChange', this.handleConnectionChange);
  ...
  //        this.hideLoading();
      ...
      if(this.state.loading){
        ...
        <>
              ...
              >
                ...
                <View style ={{width:wp('100%'),flexDirection:'row',justifyContent:'space-between',height:hp('8%'), elevation:5}}>
                  ...
                  <View style = {{width :wp('100%'),alignSelf:'center',alignItems:'center',margin:0,marginTop:hp('1.5%'), backgroundColor:'#FAFAFA'}}>
                  ...
                  <Carousel
                    ...
                    <TouchableOpacity style={{width:wp(19),height:25.5,backgroundColor:'#1976D2', padding:4, borderRadius:20}}
                  ...
                  <Carousel
                   ...
                   View all</Text>
                    ...
                    <FlatList style={{flexGrow:0,marginTop:10,marginLeft:3}}
                   ...
                   <Text style = {{color:'white',fontSize: 14,fontFamily:'AvenirLTStd-Medium',alignSelf:'center'}}>
                   View all</Text>
                   </TouchableOpacity>
                    </View>
    ...
    <DialogComponent
        ...
        dialogStyle={{width:wp(80), height:hp(25),borderRadius:15,}}
        ref={(dialogComponents) => { this.dialogComponents = dialogComponents; }}>

      <DialogContent>

    <View style={{flexDirection:'column', width:wp(80),alignSelf:'center'
    ,backgroundColor:'white', height:hp(25),borderRadius:15, }}>

    <Image style={{width: 50, height:50, resizeMode:'contain', alignSelf:'center'}}
    source={require('./resources/call.png')}/>

  <Text style = {{color:'black',fontSize: 18,width:'85%',fontFamily:'AvenirLTStd-Medium', marginTop:15,alignSelf:'center', textAlign:'center', lineHeight:27}}>
  Dr. Manish Malhotra sent you a video request
  </Text>

    <View style={{flexDirection:'row', width:'90%', justifyContent:'space-between', alignSelf:'center', marginTop:5}}>
    <DialogButton text="Reject" align="center" textStyle ={{color:'red'}}
    activeOpacity={0.99}
    onPress={()=>{this.dialogComponents.dismiss()}}/>

    <DialogButton text="Accept" align="center" textStyle ={{color:'green'}}
    activeOpacity={0.99}
    onPress={()=>{this.dialogComponents.dismiss()}}/>
